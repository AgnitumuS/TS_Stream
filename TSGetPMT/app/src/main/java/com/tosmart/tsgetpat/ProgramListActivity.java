...
import com.tosmart.tsgetpat.beans.tables.Pmt;
...
public class ProgramListActivity extends AppCompatActivity {
        ...
        mAdapter.setOnItemClickListener(new ProgramListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (mFilePath != null) {
                    ...
                    showPopupWindow();
                    String str = getResources().getString(R.string.programlist_popupwidow_tv_pmt_id_result);
    ...
    private void showPopupWindow() {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.programlist_popupwindow_pmt, null);
        ...
        View locationView = LayoutInflater.from(this).inflate(R.layout.programlist_activity, null);
        popupWindow.showAtLocation(locationView, Gravity.CENTER, 0, 0);

        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            @Override
            public void onDismiss() {
                mPmtResultTv.setText(getResources().getString(R.string.programlist_popupwidow_tv_pmt_waitting));
            }
        });
    }
