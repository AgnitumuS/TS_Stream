...
import com.tosmart.tsgetpmt.ProgramListActivity;
import com.tosmart.tsgetpmt.beans.Packet;
    ...
    private void parseTable(List<Section> list, int pid) {
        ...
        switch (pid) {
            case PAT_PID:
                ...
                mHandler.sendEmptyMessage(ProgramListActivity.REFRESH_UI_PROGRAM_LIST_PAT);
                break;
            ...
            default:
                if (list.get(0).getTableId() == PMT_TABLE_ID) {
                    ...
                    mHandler.sendEmptyMessage(ProgramListActivity.REFRESH_UI_PROGRAM_LIST_PMT);
                }
                break;
        }
    }
